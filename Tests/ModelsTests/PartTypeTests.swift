...
struct PartTypeTests {
    @Test("Vocal part types are identified correctly")
    func vocalTypes() {
    ...
    @Test("Non-vocal part types are identified correctly")
    func nonVocalTypes() {
    ...
    @Test("Default MIDI programs are correct")
    func defaultMidiPrograms() {
